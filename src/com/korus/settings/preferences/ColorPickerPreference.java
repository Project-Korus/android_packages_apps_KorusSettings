package com.korus.settings.preferences;
...
import com.korus.settings.KorusSettings;
import com.korus.settings.preferences.ColorPickerDialog.OnColorChangedListener;
...
public class ColorPickerPreference extends Preference implements OnPreferenceClickListener, OnColorChangedListener {
    ...
    protected void showDialog(Bundle state) {
        if (mDialog == null || !mDialog.isShowing()) {
            ...
            KorusSettings.lockCurrentOrientation((SettingsActivity) getContext());
